...
function switchTab(tabName) {
    ...
    if (tabName === 'products') {
        ...
        btnProducts.classList.remove('btn-outline');
        btnProducts.classList.add('btn');
        btnOrders.classList.remove('btn');
        btnOrders.classList.add('btn-outline');
    } else {
        productsView.style.display = 'none';
        ordersView.style.display = 'block';
        btnProducts.classList.remove('btn');
        btnProducts.classList.add('btn-outline');
        btnOrders.classList.remove('btn-outline');
        btnOrders.classList.add('btn');
        renderOrdersTable(); // Fetch when switching
    }
}
    ...
    orders.forEach(order => {
        ...
        const row = `
            <tr>
                ...
                <td>
                    <select onchange="handleStatusChange('${order.id}', this.value)" style="padding: 4px; border-radius: 4px; border: 1px solid #ddd;">
